...
public class ItemService {
	...
	public ItemService(ItemRepository itemRepository, UserService userService, CategoryService categoryService) {
	...
	// 글 추가
	public boolean addPost(int userId, int categoryId, String title, String content, MultipartFile photo, String itemDate) {
	...
	public List<PostDTO> getPostList(int loginUserId) {
		...
		for(Item item : itemList) {
			...
			Category category = categoryService.findId(item.getCategoryId());
	...
	public List<PostDTO> getpostByCategoryId(int categoryId) {
		...
		List<Item> itemList = itemRepository.findByCategoryIdOrderByIdDesc(categoryId);
